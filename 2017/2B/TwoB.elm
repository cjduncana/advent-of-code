...
solution =
    input
        |> List.map divisibleInList
        |> List.sum


divisibleInList : List Int -> Int
divisibleInList intList =
    case intList of
        [] ->
            0

        int :: ints ->
            case divisible int ints of
                Nothing ->
                    divisibleInList ints

                Just value ->
                    value


divisible : Int -> List Int -> Maybe Int
divisible value intList =
    case intList of
        [] ->
            Nothing
